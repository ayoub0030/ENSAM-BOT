...
#
#GEMINI_API_KEYS = [
    os.getenv("GEMINI_API_KEY_1", "AIzaSyAk3BZWSpw131SFQREJUQakgyjkBStC0RY"),
    os.getenv("GEMINI_API_KEY_2", "AIzaSyCTIgnKSJW7AGgsiQ_l2JyKWj596h13W-k"),
    os.getenv("GEMINI_API_KEY_3", "AIzaSyDe3LVgYtZH1hWjETF4T3PR3VasQzor8qg"),
#]
#
#API_QUOTA_LIMIT = 10          # requests per 60s per project/model
#API_QUOTA_WINDOW = 60  
...
#class VanillaRAG:
    ...
    def _invoke_with_gemini(self, prompt: str):
        max_retries = len(self.gemini_manager.api_keys)
        last_error = None
        for _ in range(max_retries):
            try:
